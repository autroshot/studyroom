...
### `new Date(datestring)`
인수가 하나이고 문자열이라면 해당 문자열은 자동으로 구문 분석(parsed)된다. 구문 분석에 적용되는 알고리즘은 아래 [Date.parse](https://github.com/autroshot/studyroom/edit/main/01-javascript/01-%EC%BD%94%EC%96%B4%20%EC%9E%90%EB%B0%94%EC%8A%A4%ED%81%AC%EB%A6%BD%ED%8A%B8/05-%EC%9E%90%EB%A3%8C%EA%B5%AC%EC%A1%B0%EC%99%80%20%EC%9E%90%EB%A3%8C%ED%98%95.md#dateparse%EC%99%80-%EB%AC%B8%EC%9E%90%EC%97%B4)에서 사용하는 알고리즘과 동일하다.
