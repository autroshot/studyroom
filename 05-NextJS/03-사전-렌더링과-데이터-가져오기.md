...
<이미지 pre-rendering.png>

<이미지 no-pre-rendering.png>
...
<이미지 static-generation.png>

<이미지 server-side-rendering.png>
...
<이미지 static-generation-without-data.png>
...
<이미지 static-generation-with-data.png>
...
기본적으로 `getStaticProps`는 Next.js에게 다음과 같이 말하는 것이다. "이 페이지에는 데이터 종속성이 있어! 그러니 빌드 타임에서 이 페이지를 사전 렌더링할 때, 이 문제를 먼저 해결해야 해!"
