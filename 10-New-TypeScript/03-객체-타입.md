...
We can also read from those properties - but when we do under [`strictNullChecks`](https://github.com/microsoft/TypeScript-Website/blob/v2/tsconfig#strictNullChecks), TypeScript will tell us they're potentially `undefined`.
...
Using [mapping modifiers](https://github.com/microsoft/TypeScript-Website/blob/v2/docs/handbook/2/mapped-types.html#mapping-modifiers), you can remove `optional` attributes.
...
Using [mapping modifiers](https://github.com/microsoft/TypeScript-Website/blob/v2/docs/handbook/2/mapped-types.html#mapping-modifiers), you can remove `readonly` attributes.
...
This also means that we can avoid overloads entirely by instead using [generic functions](https://github.com/microsoft/TypeScript-Website/blob/v2/docs/handbook/2/functions.html#generic-functions).
...
Why might optional and rest elements be useful? Well, it allows TypeScript to correspond tuples with parameter lists. Tuples types can be used in [rest parameters and arguments](https://github.com/microsoft/TypeScript-Website/blob/v2/docs/handbook/2/functions.html#rest-parameters-and-arguments), so that the following:
